# This is a version of your Fitts' Law experiment code adapted for Difficulty 3:
# W = 70 px, D = 240 px, and uses the proper rectangle bounds in mm
...
SERIAL_PORT = 'COM7'
W_VALUES = [70]  # Width for difficulty 3
D_VALUES = [240]  # Distance for difficulty 3
TOTAL_TRIALS = 20
...
trial_count = {}
difficulty = 1  # Index 0 used for difficulty 3
clicks = 0
target_side = 1
previous_rects = []
data = []
...
def handle_serial_click(event=None):
    ...
    throughput = 3 / (mt / 1000) if mt > 0 else 0
...
def save_data_and_finish():
    ...
    filename = f"{participant_name}_{participant_id}_{vibro_label}_ID3_trial{trial_count[participant_id][difficulty]}.xlsx"
