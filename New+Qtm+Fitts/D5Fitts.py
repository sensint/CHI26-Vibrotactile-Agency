# Fitts' Law Experiment Code for Difficulty 5 (W = 50 px, D = 800 px)
...
SERIAL_PORT = 'COM7'
W_VALUES = [50]  # Width for difficulty 5
D_VALUES = [800]  # Distance for difficulty 5
TOTAL_TRIALS = 20
...
# Convert 800 px (center distance) and 50 px (W) to mm on a 1920 px wide, 346 mm screen
# mm_per_px = 346 mm / 1920 px = 0.1802 mm/px
# center = 400 px -> 400 * 0.1802 = 72.08 mm
# half-width = 25 px -> 4.51 mm
# Final: Left = -76.59 to -67.56, Right = 67.56 to 76.59
...
def handle_serial_click(event=None):
    ...
    throughput = 5 / (mt / 1000) if mt > 0 else 0
...
def save_data_and_finish():
    ...
    filename = f"{participant_name}_{participant_id}_{vibro_label}_ID5_trial{trial_count[participant_id][difficulty]}.xlsx"
